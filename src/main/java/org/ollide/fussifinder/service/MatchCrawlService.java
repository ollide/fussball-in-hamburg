...
@Service
public class MatchCrawlService {

    private static final Logger LOGGER = LoggerFactory.getLogger(MatchCrawlService.class);
    ...
    @Autowired
    public MatchCrawlService(MatchClient matchClient) {
